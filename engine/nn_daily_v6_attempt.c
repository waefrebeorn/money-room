...
int main(int argc, char **argv) {
    ...
    printf("=== NN DAILY — SP500+VIX Regime Paper Proof (2-layer 32→16→1) ===\n");
    printf("Agents: %d  Network: %d→%d→%d→%d  LR: %.4f\n\n",
           N, N_INPUTS, N_HIDDEN_1, N_HIDDEN_2, N_OUTPUTS, LEARN_RATE);
    ...
    for (int t = WARMUP; t < nd; t++) {
        ...
        compute_daily_features(px, vx, vy, t, features, 13);
