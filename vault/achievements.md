...
109|
110|108|108|108|108|108|108|108|108|108|108||| CB-POLITICIAN | **Politician Portfolio compiled**: politician_portfolio.c (388 lines) compiled 0w 0e. Reads congress_trades.db, outputs portfolio analytics (HHI concentration, conviction score, leaderboard). Wrapper + collector_runner SLOW 240min. | `engine/politician_portfolio.c`, `~/.hermes/scripts/politician_portfolio.sh`, `engine/collector_runner.c:174` |
111|
112|109|109|109|109|109|109|109|109|109|109||| IV-RANK | **IV Rank Calculator**: iv_rank.c (180 lines) reads options flow SQLite DBs, computes IV rank/percentile per ticker. Filters out garbage IV (>200% or <1%). Reports calendar_days vs snapshot count. Outputs docs/data/iv_rank.json. Wired collector_runner 60min. | `engine/iv_rank.c`, `~/.hermes/scripts/iv_rank.sh`, `docs/data/iv_rank.json` |
